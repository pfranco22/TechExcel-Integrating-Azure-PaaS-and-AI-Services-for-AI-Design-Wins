...
public class DatabaseService : IDatabaseService
{
    ...
    [KernelFunction]
    [Description("Get all booking from specific hotel.")]
    public async Task<IEnumerable<Booking>> GetBookingsForHotel(
        [Description("The ID of the hotel to get bookings for.")] int hotelId
    )
    {
    ...
    [KernelFunction]
    [Description("Get all booking from specific hotel after a specified date.")]
    ...
    [KernelFunction]
    [Description("Get all booking that are missing hotel rooms.")]
    ...
    [KernelFunction]
    [Description("Get all booking that have multiple hotel rooms.")]
